---
title: kamajictl create tcp
---	

## kamajictl create tcp

create Kamaji Teant Control Plane

```
kamajictl create tcp NAME [flags]
```
...
```
  ...
  -v, --verbosity int8                 Verbosity level (default 1)
      --version string                 The Kubernetes version of the TenantControlPlane (default "v1.26.1")
```
