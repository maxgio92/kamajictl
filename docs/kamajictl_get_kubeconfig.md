---
title: kamajictl get kubeconfig
---	

## kamajictl get kubeconfig

get kubeconfig of a Kamaji Teant Control Plane

```
kamajictl get kubeconfig [TCP NAME] [flags]
```
...
```
  ...
  -o, --output string                  Output format. One of ("yaml", "table") (default "table")
